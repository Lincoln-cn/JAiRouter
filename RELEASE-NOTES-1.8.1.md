...
### 🐳 Docker 镜像优化
- ✅ JLink 优化的 Dockerfile，镜像体积减少 36%
- ✅ 多阶段构建优化，构建速度更快
- ✅ 镜像大小优化至 ~130MB
...
<details>
<summary>点击查看完整提交记录（24 commits）</summary>
...
### 文档更新
- docs: 添加 v1.8.1 快速开始指南
- docs: 更新 README 添加密钥生成工具使用说明
- docs: 整理 innerdoc 文档结构（第二版）
- docs: 将文档移动到对应子文件夹
- docs: 更新开发计划 -2026 为 v1.8.1 完成状态
- docs: 删除重复的开发计划文件
- docs: add English documentation for optimized Docker image
- docs: 更新 Docker 部署文档和优化版镜像说明

### 测试优化
- test: 删除重复和无价值的单元测试
- test: 删除 WebAdmin 和资源测试
- test: 删除 ModelManager 和 Tracing 测试
- test: 删除更多无价值的测试
- test: 删除剩余的问题测试
- docs: 添加测试清理总结文档
...
**完整对比**: [v1.7.3...v1.8.1](https://github.com/Lincoln-cn/JAiRouter/compare/v1.7.3...v1.8.1)
