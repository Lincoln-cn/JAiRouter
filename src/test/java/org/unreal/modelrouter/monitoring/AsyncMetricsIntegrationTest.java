...
class AsyncMetricsIntegrationTest {
    ...
    void setUp() {
        ...
        MonitoringProperties.Performance perfConfig = new MonitoringProperties.Performance();
        ...
        MonitoringProperties.Sampling samplingConfig = new MonitoringProperties.Sampling();
