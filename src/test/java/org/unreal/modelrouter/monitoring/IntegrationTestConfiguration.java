...
public class IntegrationTestConfiguration {
    ...
    public MonitoringProperties testMonitoringProperties() {
        ...
        // 性能优化配置
        MonitoringProperties.PerformanceConfig performance = new MonitoringProperties.PerformanceConfig();
        ...
        // 采样配置
        MonitoringProperties.SamplingConfig sampling = new MonitoringProperties.SamplingConfig();
