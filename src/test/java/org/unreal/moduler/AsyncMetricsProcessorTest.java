...
class AsyncMetricsProcessorTest {
    ...
    @Mock
    private MonitoringProperties.SamplingConfig samplingConfig;

    @Mock
    private MonitoringProperties.PerformanceConfig performanceConfig;
    ...
    void testBatchProcessing() throws InterruptedException {
        // 配置小批量大小
        when(performanceConfig.getBatchSize()).thenReturn(2);
    ...
    void testQueueOverflow() {
        ...
        MonitoringProperties.PerformanceConfig smallPerfConfig = mock(MonitoringProperties.PerformanceConfig.class);
        MonitoringProperties.SamplingConfig smallSamplingConfig = mock(MonitoringProperties.SamplingConfig.class);
    ...
    void testErrorHandling() {
        ...
        // 验证熔断器记录了失败（可能需要更长时间）
        verify(circuitBreaker, timeout(2000).atLeastOnce()).recordFailure();
    }
