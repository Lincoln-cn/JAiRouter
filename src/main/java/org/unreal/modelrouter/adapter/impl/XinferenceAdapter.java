...
public class XinferenceAdapter extends BaseAdapter {
    ...
    public XinferenceAdapter(ModelServiceRegistry registry, MetricsCollector metricsCollector, ObjectMapper objectMapper, ModelCallStatsRepository statsRepository) {
