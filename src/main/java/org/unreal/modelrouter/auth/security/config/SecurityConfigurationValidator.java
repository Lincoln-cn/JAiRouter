...
public class SecurityConfigurationValidator {
     ...
     * 验证敏感词列表
     */
    private void validateSensitiveWords(
            final List<String> sensitiveWords, final String context,
     ...
     * 验证PII模式列表
     */
    private void validatePiiPatterns(
            final List<String> piiPatterns, final String context,
            final ValidationResult result) {
