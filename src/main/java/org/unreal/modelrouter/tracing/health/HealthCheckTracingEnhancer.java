...
public class HealthCheckTracingEnhancer {
    ...
    private final DefaultTracingContext tracingContextFactory;
    ...
    public HealthCheckTracingEnhancer(StructuredLogger structuredLogger, 
                                     DefaultTracingContext tracingContextFactory) {
        this.structuredLogger = structuredLogger;
        this.tracingContextFactory = tracingContextFactory;
    }
    ...
    public TracingContext createHealthCheckContext(String serviceType, ModelRouterProperties.ModelInstance instance) {
        // 创建独立的追踪上下文用于健康检查
        TracingContext context = tracingContextFactory.createRootContext();
